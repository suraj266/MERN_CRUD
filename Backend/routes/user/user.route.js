...
router.route("/Login").get(Controller.Login); // Login user
router.route("/List").get(userAuth, Controller.List); // Listing of users by Id and without Id both
router.route("/Update/:id").put(userAdmin, Controller.Update); // Update user data
